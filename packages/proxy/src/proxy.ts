...
import { WORKBENCH_OVERVIEW_METHOD } from "@codex-toys/workbench";
...
async function handleApiRequest(
	...
	if (request.method === "POST" && apiPath.startsWith("/workbench/")) {
		const requested = decodeURIComponent(apiPath.slice("/workbench/".length));
