...
export class CodexAppServerClient extends CodexEventEmitter {
  ...
  constructor(options: CodexAppServerClientOptions = {}) {
    ...
    this.transport.on("notification", (message) => this.emit("notification", message));
    this.transport.on("request", (message) => this.emit("request", message));
    this.transport.on("stderr", (line) => this.emit("stderr", line));
    this.transport.on("close", (code, signal) => this.emit("close", code, signal));
  ...
  listThreadTurns(params: v2.ThreadTurnsListParams): Promise<v2.ThreadTurnsListResponse> {
  ...
  listThreadTurnItems(
    ...
    return this.request<v2.ThreadTurnsItemsListResponse>("thread/turns/items/list", params);
  }
  ...
  interruptTurn(params: v2.TurnInterruptParams): Promise<v2.TurnInterruptResponse> {
  ...
  commandExecWrite(params: v2.CommandExecWriteParams): Promise<v2.CommandExecWriteResponse> {
  ...
  commandExecTerminate(
    ...
    return this.request<v2.CommandExecTerminateResponse>("command/exec/terminate", params);
  }
  ...
  installedPlugins(params: v2.PluginInstalledParams): Promise<v2.PluginInstalledResponse> {
    return this.request<v2.PluginInstalledResponse>("plugin/installed", params);
  }

  installPlugin(params: v2.PluginInstallParams): Promise<v2.PluginInstallResponse> {
    return this.request<v2.PluginInstallResponse>("plugin/install", params);
  }
  ...
  updatePluginShareTargets(
    ...
    return this.request<v2.PluginShareUpdateTargetsResponse>("plugin/share/updateTargets", params);
  }

  readPluginSkill(params: v2.PluginSkillReadParams): Promise<v2.PluginSkillReadResponse> {
...
function defaultTransport(options: CodexAppServerClientOptions): CodexAppServerTransport {
